...
export default function CanvasOfBabble() {
    ...
    function generateNewCanvas(nextSeed?: number) {
        ...
        // Actually render the image data to canvas
    ...
    return (
        ...
        <ToolCard title="Canvas of Babble">
            ...
            <div className="babble-controls">
                ...
                <button id="randomSeedBtn" onClick={() => {
